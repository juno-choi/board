package com.juno.simple.global.advice;

import com.juno.simple.global.api.ErrorDto;
...
public class GlobalAdvice {
    ...
    private ProblemDetail createProblemDetail(HttpStatus httpStatus, String detail, List<ErrorDto> errors) {
        ...
        problemDetail.setType(URI.create(Optional.ofNullable(env.getProperty("springdoc.swagger-ui.path")).orElse("/api/")));
